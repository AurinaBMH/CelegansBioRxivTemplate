...
Our list of hubs includes all of the 11 hub neurons of Towlson et al.~\cite{Towlson2013} at $3 \sigma$ (see Fig.~\ref{tab:HubList}) with five additional hubs identified in our analysis of the directed connectome.
...
% ------------------------------------------------------------------------------
 \begin{figure}[h!]
 \centering
    \includegraphics[width=0.78\textwidth]{MeanCoexpression5.pdf}
...
We thank WormBase and particularly Daniela Raciti for providing valuable information regarding the \emph{C. elegans} gene expression data, and Taqi Ali for for preliminary data processing.
...
% \input{simpleTemplate.bbl}
\input{CelegansHubs.bbl}
...
For each hub, we list (i) the neuron name, (ii) its degree, $k$, (iii) location (`head', `body', or `tail'), and function based on information presented in the Wormatlas website, \url{www.wormatlas.org/}.
Neurons are sorted (descending) by degree.}
\label{tab:HubList}
\begin{tabular}{lll}
\hline
